...
QT_MOC_LITERAL(1, 8, 10), // "deleteLeap"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 13) // "takeSnapShoot"

    },
    "MyClass\0deleteLeap\0\0takeSnapShoot"
};
...
void MyClass::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->deleteLeap(); break;
        case 1: _t->takeSnapShoot(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyClass::deleteLeap)) {
                *result = 0;
            }
        }
    }
